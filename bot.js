...
client.on("message", function(message) {//////////////////Mal Team  By:Mal Mahmoud-QuaStyle
	var prefix = "$";
   if(message.content.startsWith(prefix + "rps")) {
    ...
    message.channel.send(RpsEmbed).then(msg => {
        ...
        msg.react("🇸")
        msg.react("🇵")
.then(() => msg.react('🇷'))//////////////////Mal Team  By:Mal Mahmoud-QuaStyle
.then(() =>msg.react('🇸'))
.then(() => msg.react('🇵'))
let reaction1Filter = (reaction, user) => reaction.emoji.name === '🇷' && user.id === message.author.id;
let reaction2Filter = (reaction, user) => reaction.emoji.name === '🇸' && user.id === message.author.id;
...
//Left the voice channel [ function ] ,-,////Mal Team  By:Mal Mahmoud-QuaStyle
...
function play(guild, song, message) {
	setTimeout(function(){
		...
		embed.setURL(serverQueue.songs[0].url)
		serverQueue.textChannel.send(embed)
	},10);/////////////Mal Team  By:Mal Mahmoud-QuaStyle
}
